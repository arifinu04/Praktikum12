package com.app.praktikum12.adapter
...
import com.app.praktikum12.R
import com.app.praktikum12.databinding.UserListBinding
import com.app.praktikum12.model.Mahasiswa
...
class HomeAdapter(private val dataMhs: ArrayList<Mahasiswa>) : RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener {
            ...
            findNavController(it).navigate(R.id.action_homeFragment_to_detailFragment3, bundle)
        }
        ...
        holder.binding.btnEdit.setOnClickListener {
            ...
            bundle.putString("nama", dataMhs[position].nama)
            bundle.putString("telepon", dataMhs[position].telepon)
            findNavController(it).navigate(R.id.action_homeFragment_to_updateFragment3, bundle)
        }
    }
